...
export default function TransformationCard({ transformation, maxKi }: { transformation: Transformations; maxKi: bigint }) {
  ...
  return (
    <article className='group relative flex flex-col cursor-pointer overflow-hidden rounded-lg border-2 border-orange-500 bg-linear-to-b from-orange-950 to-black p-4 shadow-[0_0_15px_rgba(249,115,22,0.3)] transition-all hover:scale-105 hover:shadow-[0_0_25px_rgba(249,115,22,0.6)]'>
