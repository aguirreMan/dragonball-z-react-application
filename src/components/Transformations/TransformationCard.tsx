...
export default function TransformationCard({ transformation, maxKi }: { transformation: Transformations; maxKi: bigint }) {
  ...
  return (
    <article className='group relative flex flex-col cursor-pointer overflow-hidden rounded-lg border-2 border-primary bg-linear-to-b from-orange-950 to-black p-4 transform-glow transition-all hover:scale-105 hover:shadow-[0_0_25px_rgba(249,115,22,0.6)]'>
      <div className='absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(234,179,8,0.1),transparent_50%)]' />
      <h2 className='relative z-10 mb-3 text-center text-xl font-bold uppercase tracking-wider text-primary drop-shadow-[0_2px_8px_rgba(234,179,8,0.8)] transition-all group-hover:text-transformation-gold'>
        {transformation.name}
      </h2>
